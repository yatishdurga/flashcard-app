export const questionsData = {
    ...
    "Statistics": [
      ...
      { question: "Define standard deviation.", answer: "Standard deviation measures the amount of variation or dispersion in a dataset." },
      { question: "What is the central limit theorem?", answer: "The central limit theorem states that the sampling distribution of the sample mean approaches a normal distribution as the sample size increases." },
      { question: "What is hypothesis testing?", answer: "Hypothesis testing is a statistical method used to determine the validity of a claim or assumption about a population." },
      { question: "Define correlation.", answer: "Correlation measures the strength and direction of a linear relationship between two variables." }
    ]
  };
